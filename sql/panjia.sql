...
select setval(pg_get_serial_sequence('gen_table', 'table_id'), (select max(table_id) from gen_table));
...
select setval(pg_get_serial_sequence('gen_table_column', 'column_id'), (select max(column_id) from gen_table_column));
